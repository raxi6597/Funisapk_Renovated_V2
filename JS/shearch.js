...
cards.forEach(function(card) {
    ...
    if (cardFechaHoraString) {
        ...
        // Formatea la fecha almacenada en data-fecha-hora en el mismo formato que currentDate
        var formattedCardFechaHora = cardFechaHora.toLocaleString('en-US', {
            year: 'numeric',
            month: '2-digit',
            day: '2-digit',
            hour: 'numeric',
        ...
        if (formattedCardFechaHora === currentDate) {
            // Muestra la card si la fecha coincide con la actual
            ...
            // Si la fecha no coincide, oculta la card
            card.style.display = "none";
